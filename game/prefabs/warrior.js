...
var Warrior = function(game, x, y, fluidCG, warriorCG, arrowCG) {
...
Warrior.prototype.addArrow = function(){
    ...
    this.fireArrows.add(new FireArrow(this.game, this.x, this.y, this.curDir, this.fluidCG, this.arrowCG));
}
